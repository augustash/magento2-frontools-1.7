...
```bash
$ composer config repositories.augustash-frontools-1.7 vcs https://github.com/augustash/magento2-frontools-1.7.git
$ composer require snowdog/frontools:~1.7.2
```
